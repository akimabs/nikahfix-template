...
export default function SongButton() {
  ...
  return (
    <>
      {/* Now Playing Toast */}
      {showToast && (
        <div className={`fixed bottom-12 right-5 z-50 ${isClosing ? 'animate-slide-out-right' : 'animate-slide-in-right'}`}>
          <div className="bg-black/90 backdrop-blur-sm text-white px-3 py-2 rounded-lg shadow-lg border border-gray-700">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
              <span className="text-xs text-white">
                {data.song_info.title} - {data.song_info.artist}
              </span>
            </div>
          </div>
        </div>
